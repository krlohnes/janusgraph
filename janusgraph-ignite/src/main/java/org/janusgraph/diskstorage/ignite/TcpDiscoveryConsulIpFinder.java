 ...
 */
//TODO remove this and add it in lib in running distro
//Only added for quick testing
...
public class TcpDiscoveryConsulIpFinder extends TcpDiscoveryIpFinderAdapter {
    ...
    public static final String SERVICE_NAME = "janusgraph";

    /** Key for retrieving Consul address from system properties */
    public static final String PROP_CONSUL_ADDRESS_KEY = "CONSUL_HOST";

    /** Key for retrieving Consul port from system properties */
    public static final String PROP_CONSUL_PORT_KEY = "CONSUL_PORT";
